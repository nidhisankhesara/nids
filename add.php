...
<?php
	...
	$mno = $_POST["mobile"];
	$sql = "INSERT INTO places (aname,place,description,availability,type,picid,duration,cost) 
			VALUES('$_POST[aname]','$_POST[place]','$_POST[description]','$_POST[avail]','$_POST[type]','$_POST[pic]','$_POST[duration]','$_POST[cost]')";
